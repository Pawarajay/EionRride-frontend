...
//               </div>
//               {distanceError && (
//                 <div className="text-xs text-red-600 mt-1">{distanceError}</div>
//               )}
//             </div>

//             <div className="text-xl sm:text-2xl font-bold text-blue-900 text-left">
//               {pricesLoading[bookingData.vehicleType]
//                 ? "Calculating..."
//                 : prices[bookingData.vehicleType]
//                 ? prices[bookingData.vehicleType]
...
//             {bookingData.vehicleType &&
//               fareBreakdowns[bookingData.vehicleType] && (
//                 <div className="p-4 sm:p-5 rounded-lg bg-gradient-to-r from-blue-100 to-blue-50 border border-blue-300 max-w-full sm:max-w-md text-left">
//                   <h4 className="font-semibold text-blue-900 mb-3 border-b border-blue-300 pb-2 text-sm sm:text-base">
//                     Fare calculation breakdown
//                   </h4>
//                   <ul className="text-xs sm:text-sm space-y-1 list-disc list-inside text-blue-900 font-medium">
...
//                 <Card className="p-4 sm:p-6">
//                   <CardContent className="p-0">
//                     <h3 className="text-base sm:text-lg font-semibold mb-3 text-blue-600 text-left">
//                       Actual usage (for extra charges)
//                     </h3>
//                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                       <div>
...
//           <div ref={bookingFormRef} className="space-y-6">
//             {inlineMessage && (
//               <div className="mb-4 rounded-md border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800 text-left">
//                 {inlineMessage}
//               </div>
//             )}
...
//             <Card className="p-4 sm:p-6">
//               <CardContent className="p-0">
//                 <h3 className="text-base sm:text-lg font-semibold mb-4 text-left">
//                   Who are you booking for?
//                 </h3>
//                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                   <button
...
//                     Coupon applied: {bookingData.discount}% off
//                   </div>
//                 )}
//               </div>
//               <Button
