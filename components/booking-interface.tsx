...
//   return (
//     <div className="bg-white/95 w-full p-5 sm:p-6 rounded-xl lg:rounded-2xl border border-gray-200 shadow-lg space-y-5 text-left">
//       {/* MAP PICKER MODAL */}
//       {showMapPicker && (
//         <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
//           <div className="bg-white rounded-lg w-full max-w-4xl h-[600px] flex flex-col shadow-2xl">
...
//             type="button"
//             onClick={handleOpenMapPicker}
//             className="absolute right-3 top-1/2 -translate-y-1/2 hover:bg-blue-50 rounded-full p-1 transition-colors cursor-pointer"
//             title="Pick location from map"
//           >
//             <Navigation className="w-5 h-5 text-blue-500" />
//           </button>
